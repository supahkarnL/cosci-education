import {
  __commonJS
} from "./chunk-LP7MLKPC.js";

// node_modules/chartjs-plugin-labels/src/chartjs-plugin-labels.js
var require_chartjs_plugin_labels = __commonJS({
  "node_modules/chartjs-plugin-labels/src/chartjs-plugin-labels.js"() {
    (function() {
      "use strict";
      ...
      Label.prototype.renderToDataset = function(dataset, index) {
        ...
        arg.meta.data.forEach(function(element, index2) {
          this.renderToElement(dataset, arg, element, index2);
        }.bind(this));
      };
      ...
      Label.prototype.getLabel = function(dataset, element, index) {
        ...
        } else if (label !== null && label !== void 0) {
      ...
      Label.prototype.measureLabel = function(label) {
        if (typeof label === "object") {
          ...
          return { width, height: this.options.fontSize * lines.length };
        }
      };
...
// dep:chartjs-plugin-labels
var chartjs_plugin_labels_default = require_chartjs_plugin_labels();
export {
  chartjs_plugin_labels_default as default
};
/**
